...
for (const [name, value] of [
  ...
  ["AIPMS_TOKEN_ENCRYPTION_SECRET", secret("AIPMS_TOKEN_ENCRYPTION_SECRET")],
  [
    "AIPMS_TOKEN_ENCRYPTION_PREVIOUS_SECRET",
    secret("AIPMS_TOKEN_ENCRYPTION_PREVIOUS_SECRET", 32, true),
  ],
